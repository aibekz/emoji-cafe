...
(async function() {
  ...
  const items = await Item.create([
    ...
    {name: 'Sushi', emoji: '🍣', category: categories[1], price: 9.95},
    {name: 'Grilled Fish', emoji: '🐟', category: categories[1], price: 12.95},
    {name: 'Taco', emoji: '🌮', category: categories[2], price: 1.95},
    {name: 'Burrito', emoji: '🌯', category: categories[2], price: 4.95},
    {name: 'Tamale', emoji: '🫔', category: categories[2], price: 3.95},
    {name: 'Guacamole', emoji: '🥑', category: categories[2], price: 2.95},
    ...
    {name: 'Cheese Plate', emoji: '🧀', category: categories[3], price: 4.95},
    {name: 'French Fries', emoji: '🍟', category: categories[4], price: 2.95},
    {name: 'Green Salad', emoji: '🥗', category: categories[4], price: 3.95},
    {name: 'Onion Rings', emoji: '🧅', category: categories[4], price: 3.45},
    {name: 'Corn on the Cob', emoji: '🌽', category: categories[4], price: 2.45},
    ...
    {name: 'Donut', emoji: '🍩', category: categories[5], price: 1.45},
    {name: 'Cookie', emoji: '🍪', category: categories[5], price: 0.95},
    ...
    {name: 'Juice', emoji: '🧃', category: categories[6], price: 1.95},
    {name: 'Soda', emoji: '🥤', category: categories[6], price: 1.45},
    {name: 'Tea', emoji: '🍵', category: categories[6], price: 0.95},
  ]);
